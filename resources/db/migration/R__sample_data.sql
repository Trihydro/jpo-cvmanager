...
INSERT INTO rsu_models(name, supported_radio, manufacturer)
  VALUES ('ITS-RS4-M', 'DSRC,C-V2X', 1), ('RSU2X US', 'DSRC,C-V2X', 2), ('RIS-9260', 'C-V2X', 3)
  ON CONFLICT (name) DO NOTHING;

INSERT INTO firmware_images(name, model, install_package, version)
...
INSERT INTO firmware_upgrade_rules(from_id, to_id)
  VALUES (1, 2), (2, 3), (1, 3)
...
INSERT INTO rsu_credentials(username, password, nickname, owner_organization_id)
  VALUES ('username', 'password', 'cred1', 1),
         ('username2', 'password2', 'cred2', 2),
         ('username3', 'password3', 'cred3', 3)
  ON CONFLICT (nickname) DO NOTHING;

INSERT INTO snmp_credentials(username, password, encrypt_password, nickname, owner_organization_id)
...
INSERT INTO snmp_protocols(protocol_code, nickname)
...
INSERT INTO rsus(geography, milepost, ipv4_address, serial_number, iss_scms_id, primary_route, model, credential_id, snmp_credential_id, snmp_protocol_id, firmware_version, target_firmware_version)
  VALUES
...
INSERT INTO rsu_organization(rsu_id, organization_id)
  VALUES (1, 1), (2, 1), (3, 1),
         (1, 2), (4, 2), (5, 2),
         (1, 3), (6, 3), (7, 3)
  ON CONFLICT DO NOTHING;
...
INSERT INTO users(keycloak_id, email, first_name, last_name, created_timestamp, super_user)
  VALUES
...
INSERT INTO snmp_msgfwd_type(name)
  VALUES ('rsuDsrcFwd'), ('rsuReceivedMsg'), ('rsuXmitMsgFwding')
  ON CONFLICT (name) DO NOTHING;

INSERT INTO snmp_msgfwd_config(rsu_id, msgfwd_type, snmp_index, message_type, dest_ipv4, dest_port, start_datetime, end_datetime, active, security)
  VALUES
...
INSERT INTO email_type(email_type, required_role, description, supports_immediate, supports_hourly, supports_daily, supports_weekly, supports_monthly)
  VALUES
...
INSERT INTO user_email_notification(user_email_notification_id, user_id, email_type_id, immediate, hourly, daily, weekly, monthly)
  VALUES
...
INSERT INTO intersections(intersection_number, ref_pt, intersection_name)
  VALUES
...
INSERT INTO intersection_organization(intersection_id, organization_id)
  VALUES (1, 1), (2, 1), (3, 1),
         (1, 2), (4, 2), (5, 2),
         (1, 3), (6, 3), (7, 3)
  ON CONFLICT DO NOTHING;
...
INSERT INTO rsu_intersection(rsu_id, intersection_id)
  VALUES (1, 1), (2, 2), (3, 3)
  ON CONFLICT DO NOTHING;
...
INSERT INTO consecutive_firmware_upgrade_failures(rsu_id, consecutive_failures)
  VALUES (5, 2), (6, 1), (7, 3)
  ON CONFLICT (rsu_id) DO NOTHING;

INSERT INTO max_retry_limit_reached_instances(rsu_id, reached_at, target_firmware_version)
  VALUES
...
-- RSU 1 and RSU 2.
INSERT INTO ping(timestamp, result, rsu_id)
  SELECT ts, res, rid
  FROM (VALUES
...
INSERT INTO rsu_health(timestamp, health, rsu_id)
  SELECT ts, hlth, rid
  FROM (VALUES
  ...
  WHERE NOT EXISTS (SELECT 1 FROM rsu_health);

INSERT INTO scms_health(timestamp, health, expiration, rsu_id)
  ...
  WHERE NOT EXISTS (SELECT 1 FROM scms_health);
