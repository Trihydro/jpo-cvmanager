...
-- Credentials
DO $$ BEGIN COMMENT ON TABLE rsu_credentials IS
...
DO $$ BEGIN COMMENT ON TABLE snmp_credentials IS
...
DO $$ BEGIN COMMENT ON COLUMN rsus.primary_route IS
    'Denormalized route name (e.g., I-25, US-36). No separate route table exists.';
EXCEPTION WHEN undefined_table OR undefined_column THEN NULL; END $$;

DO $$ BEGIN COMMENT ON TABLE rsu_options IS
...
-- Health / status
DO $$ BEGIN COMMENT ON TABLE ping IS
...
DO $$ BEGIN COMMENT ON TABLE rsu_health IS
...
DO $$ BEGIN COMMENT ON TABLE scms_health IS
...
DO $$ BEGIN COMMENT ON TABLE iss_keys IS
...
DO $$ BEGIN COMMENT ON TABLE roles IS
