...
;""";
    ...
    void getUsersCount() throws SQLException {
        ...
        String expectedQuery = "select count(*) from users";
    ...
    void addUser() throws SQLException {
        ...
        String expectedQuery = "insert into users (email, keycloak_id, created_timestamp) values (?, ?::UUID, ?)";
    ...
    void updateUser() throws SQLException {
        ...
        String expectedQuery = "update users set email = ?, first_name = ?, last_name = ?, created_timestamp = ?, super_user = ?::bit where keycloak_id = ?::UUID";
    ...
    void removeUser() throws SQLException {
        ...
        String expectedQuery = "delete from users where keycloak_id = ?::UUID";
