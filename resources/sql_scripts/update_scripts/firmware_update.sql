...
DROP TABLE cvmanager.firmware_upgrade_rules;
DROP SEQUENCE cvmanager.firmware_upgrade_rules_firmware_upgrade_rule_id_seq;
DROP TABLE cvmanager.firmware_images;
DROP SEQUENCE cvmanager.firmware_images_firmware_id_seq;
DROP TABLE cvmanager.os_upgrade_rules;
DROP SEQUENCE cvmanager.os_upgrade_rules_os_upgrade_rule_id_seq;
DROP TABLE cvmanager.os_images;
DROP SEQUENCE cvmanager.os_images_os_id_seq;
