...
ALTER TABLE cvmanager.snmp_msgfwd_config
...
UPDATE cvmanager.snmp_msgfwd_config SET security = '0';
ALTER TABLE cvmanager.snmp_msgfwd_config ALTER COLUMN security SET NOT NULL;