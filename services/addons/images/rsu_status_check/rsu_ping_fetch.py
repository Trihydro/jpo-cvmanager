...
def get_rsu_data():
    ...
    query = "SELECT rsu_id, ipv4_address FROM rsus ORDER BY rsu_id"
...
def insert_rsu_ping(request_json):
    ...
    for history in histories:
        try:
            query = f'INSERT INTO ping (timestamp, result, rsu_id) VALUES (to_timestamp({history["clock"]}), B\'{history["value"]}\', {rsu_id})'
