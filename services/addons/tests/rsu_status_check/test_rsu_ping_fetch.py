...
def test_insert_rsu_ping(mock_write_db):
    ...
    expected_calls = [
        call(
            "INSERT INTO ping (timestamp, result, rsu_id) VALUES (to_timestamp(1632350648), B'1', 230)"
        ),
        call(
            "INSERT INTO ping (timestamp, result, rsu_id) VALUES (to_timestamp(1632350348), B'1', 230)"
        ),
        call(
            "INSERT INTO ping (timestamp, result, rsu_id) VALUES (to_timestamp(1632350048), B'1', 230)"
        ),
        call(
            "INSERT INTO ping (timestamp, result, rsu_id) VALUES (to_timestamp(1632349748), B'1', 230)"
        ),
        call(
            "INSERT INTO ping (timestamp, result, rsu_id) VALUES (to_timestamp(1632349448), B'1', 230)"
        ),
    ]
