...
def fetch_rsu_info(rsu_ip, organization):
    ...
    query = (
        ...
        "LEFT JOIN cvmanager.rsu_credentials AS rsu_creds ON rsu_creds.credential_id = rd.credential_id "
        "LEFT JOIN cvmanager.snmp_credentials AS snmp ON snmp.snmp_credential_id = rd.snmp_credential_id "
        "LEFT JOIN cvmanager.snmp_protocols AS snmp_ver ON snmp_ver.snmp_protocol_id = rd.snmp_protocol_id "
