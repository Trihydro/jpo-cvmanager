...
def check_for_upgrade(rsu_ip):
    ...
    query = (
        ...
        "JOIN firmware_images fi2 ON fi2.firmware_id = fur.to_id "
...
def mark_rsu_for_upgrade(rsu_ip):
    ...
    query = f"UPDATE rsus SET target_firmware_version = {upgrade_info['upgrade_id']} WHERE ipv4_address = '{rsu_ip}'"
