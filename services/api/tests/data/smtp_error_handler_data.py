...
get_subscribed_users_query = (
    "SELECT email FROM users WHERE receive_error_emails = '1'"
)
...
get_unsubscribe_user_query = (
    "SELECT receive_error_emails FROM users WHERE email = 'test@gmail.com'"
)
get_unsubscribe_user_remove_query = (
    "UPDATE users SET receive_error_emails='0' WHERE email = 'test@gmail.com'"
)
